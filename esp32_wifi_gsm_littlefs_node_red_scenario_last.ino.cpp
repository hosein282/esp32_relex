# 1 "C:\\Users\\Amin\\AppData\\Local\\Temp\\tmph0upj4ee"
#include <Arduino.h>
# 1 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
#include <LittleFS.h>
#include "base64.hpp"
...
unsigned int analog_read_threshold = 500;
...
#line 350 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
String processor(const String &var)
{
...
void callback(char *topic, byte *payload, unsigned int length)
{
  ...
  {
# 461 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
  }
  else if (event == "soff")
  {
# 489 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
  }
  else if (event == "ain")
  {
...
bool initWiFi()
{
  ...
  WiFi.mode(WIFI_STA);
# 910 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
...
void setup()
{
  ...
  for (uint8_t i = 0; i < totalOutputs; i++)
  {
    ...
    pinMode(outputs[i].gpio, OUTPUT);
  }
  for (uint8_t i = 0; i < totalInputs; i++)
  {
    pinMode(inputs[i].gpio, INPUT_PULLUP);
  }
      ...
      for (int j = 0; j < totalScenarios; j++)
      {
        ...
        if (target != 100)
        {
          if (scenario.condition == "==")
          {
            ...
            outStates[(target * 2) + 1] = targetState ? '0' : '1';
            continue;
          }
          else
          {
  ...
  for (int i = 0; i < totalScenarios; i++)
  {
    ...
    if (target != 100)
    {
      if (scenario.condition == "==")
      {
        ...
        outStates[(target * 2) + 1] = state ? '0' : '1';
        continue;
      }
      else
      {
...
# 2231 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
...
# 2311 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
}
...
String getMAC()
{
# 2610 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
...
# 2804 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
void checkRfRemote()
{
...
void handleShortPress()
{
  ...
  removeAllRemotes();
# 2893 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
}
void handleRemoteRegister()
{
...
# 2991 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
void handleRemoveRemote()
{
...
# 3148 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
void compareRemote(String received)
{
...
# 3275 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
void initSim800Mqtt()
{
...
void checkOutputSch(uint8_t input)
{
# 3578 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
}
  ...
  for (uint8_t i = 0; i < scenariosCount; i++)
  {
    ...
    if (strcmp(key, scenarios[i].key) == 0)
    {
      ...
      else
      {
        ...
        scenarios[scenariosCount - 1].value = "";
      }
      scenariosCount--;
...
# 3878 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
    else if (cmd == "+CPIN")
    {
    ...
    {
# 3899 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
      index = buff.indexOf(",");
...
# 4046 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
}
...
# 4771 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
void doAction(String phoneNumber)
{
  ...
  {
# 5125 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
  }
  else if (msg == "soff")
  {
# 5147 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
  }
  else if (msg == "balance")
  {
  ...
  {
# 5192 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
  }
  else if (msg == "wipe")
  {
...
String outputIsBusy(uint8_t index)
{
# 5251 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
  return "";
}
...
# 5835 "C:/Users/Amin/Documents/PlatformIO/Projects/250408-163529-esp32doit-devkit-v1/src/esp32_wifi_gsm_littlefs_node_red_scenario_last.ino"
...
void stringToArray(String str, int arr[])
{
  ...
  {
    arr[index++] = str.substring(start, end).toInt();
    start = end + 1;
